...
common/ThirdParty/SEGGER/SEGGER/%.o common/ThirdParty/SEGGER/SEGGER/%.su common/ThirdParty/SEGGER/SEGGER/%.cyclo: ../common/ThirdParty/SEGGER/SEGGER/%.c common/ThirdParty/SEGGER/SEGGER/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DDEBUG -DUSE_HAL_DRIVER -DSTM32F401xE -c -I../Core/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc -I../Drivers/STM32F4xx_HAL_Driver/Inc/Legacy -I../Drivers/CMSIS/Device/ST/STM32F4xx/Include -I../Drivers/CMSIS/Include -I"D:/testvht/common/ThirdParty/FreeRTOS/include" -I"D:/testvht/common/ThirdParty/FreeRTOS/portable/GCC/ARM_CM4F" -I"D:/testvht/common/ThirdParty/SEGGER/Config" -I"D:/testvht/common/ThirdParty/SEGGER/OS" -I"D:/testvht/common/ThirdParty/SEGGER/SEGGER" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -fcyclomatic-complexity -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
common/ThirdParty/SEGGER/SEGGER/%.o: ../common/ThirdParty/SEGGER/SEGGER/%.S common/ThirdParty/SEGGER/SEGGER/subdir.mk
	arm-none-eabi-gcc -mcpu=cortex-m4 -g3 -DDEBUG -c -I"D:/testvht/common/ThirdParty/SEGGER/Config" -I"D:/testvht/common/ThirdParty/SEGGER" -x assembler-with-cpp -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@" "$<"
